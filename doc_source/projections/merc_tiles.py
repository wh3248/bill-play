...
def convert_grid_to_conus(grid_x:int, grid_y:int, merc_bounds, conic_transformer, rect_size:int)->list:
...
def convert_grid_from_conus(conus_x:int, conus_y:int, merc_bounds, transformer, rect_size:int=32)->list:
    ...
    for grid_x in range(0, rect_size):
        for grid_y in range(0, rect_size):
            (x, y) = convert_grid_to_conus(grid_x, grid_y, merc_bounds, transformer, rect_size)
