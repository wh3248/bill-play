"""
Run CPU parflow for a spinup run using PFB files collected from hf_hydrodata.
"""
...
def main():
    ...
    if mode != "run":
        if shape is None:
            ...
            if False:  # Do not do this for spinup since forcing files are not used
...
def run_parflow(
    ...
    parflow_run = pf.Run.from_definition("../chen_spinup.yaml")
